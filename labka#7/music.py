...
music_folder = "/Users/merek/OneDrive/Рабочий стол/labka#7/music"
...
pygame.display.set_caption("Mereke-Playlist")
clock = pygame.time.Clock()

# артқы фонды енгіземіз
background = pygame.image.load(os.path.join("music-elements", "resized_image.png"))
